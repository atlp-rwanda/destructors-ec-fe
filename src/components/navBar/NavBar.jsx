...
>>>>>>> add post product to wishlist
  return (
    <div className={`flex flex-row justify-around items-center py-3  ${(pathname !== '/') ? " gap-[600px] xs:gap-0" : "" }`}>
      <div className="" >

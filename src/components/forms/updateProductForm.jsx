...
const ProductUpdate=()=>{
  ...
  : '';
      const onSubmit =async(data) => {
        ...
        await dispatch(updateProduct({ id, product:productUpdates,images: selectedImages }))
        reset({
            name: '',
            categoryId: '',
            description: '',
        ...
        <div>
            <form action="" onSubmit={handleSubmit(onSubmit)} encType="multipart/form-data" className="flex flex-col ml-[330px] mt-[100px] xs:ml-0 px-5 ">
                ...
                <div className='flex flex-col'>
                    ...
                    <select name="category" defaultValue='' className='border border-gray-200 ... w-[400px] h-[30px] mt-2 text-sm pl-3  text-slate-600 xs:w-full' {...register('categoryId')} value={product.categoryId ||''} onChange={e => setProduct({ ...product, 'categoryId': e.target.value })}>
                ...
                <div className='inline-grid grid-cols-2 gap-[35px] absolute top-[100px] left-[800px] xs:static xs:mt-[10px] xs:p-2 laptop:static'>
                    {
                        ...
                        selectedImages.map((image,index) => (
                            ...
                            <div className='border border-gray-200 ... w-[200px] h-[225px] text-5xl  text-slate-400 p-[20px] xs:w-[150px] bg-white xs:h-[180px] xs:p-[15px]' key={index}>
                                <img src={`${URL.createObjectURL(image)}`} alt="" className='w-[100%] object-cover hover:opacity-[0.6]' />
                                <button onClick={()=>handleRemoveImage(index)} className=""><img src={clear}/></button>
                            </div>
                        ))
                    }
                    ...
                    <div className='border border-gray-200 ... w-[200px] h-[200px] text-5xl flex flex-row text-slate-400 p-[20px] xs:w-[150px] bg-white xs:h-[150px] xs:p-[15px]'key={index}>
